  ...
  return (
    <div className="max-w-2xl mx-auto py-16 px-6 font-sans">
      <div className="flex flex-col items-center mb-12 animate-in fade-in slide-in-from-top-4 duration-700">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-white mb-2">What's New in v1.1.0</h1>
        <p className="text-slate-400">Exciting updates to your domain hunting toolkit.</p>
      </div>
      ...
      <div className="space-y-10">
        <section className="animate-in fade-in slide-in-from-left-4 duration-500 delay-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-xl font-bold text-white">Instant Pagination <span className="text-xs font-normal text-teal-500 bg-teal-500/10 px-2 py-0.5 rounded ml-2">NEW</span></h2>
          </div>
          <p className="text-slate-400 leading-relaxed">
            Browsing expired domains is now dramatically faster. Pages load without full reloads, the next page starts preloading the moment you hover "Next," and Back/Forward navigation is instant thanks to session caching. No more flickering or jumping while filtering.
          </p>
        </section>
        ...
        <section className="animate-in fade-in slide-in-from-left-4 duration-500 delay-200">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-xl font-bold text-white">Quick Actions <span className="text-xs font-normal text-teal-500 bg-teal-500/10 px-2 py-0.5 rounded ml-2">NEW</span></h2>
          </div>
          <p className="text-slate-400 leading-relaxed">
            Hover over any domain name to reveal a singleton tooltip with quick shortcuts. Copy the domain, open it in a new tab, check the Wayback Machine, or perform instant Whois/DNS lookups without ever leaving the page.
          </p>
        </section>
        ...
        <section className="animate-in fade-in slide-in-from-left-4 duration-500 delay-300">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-xl font-bold text-white">Smarter Filtering</h2>
          </div>
          <p className="text-slate-400 leading-relaxed">
            Filters now respond faster with less CPU usage — no more lag when typing, even on large domain lists. TLD detection (like <code className="text-teal-400">.co.uk</code>) is also more accurate.
          </p>
        </section>

        <section className="animate-in fade-in slide-in-from-left-4 duration-500 delay-400">
          <div className="flex items-center gap-2 mb-3">
            <div className="p-1.5 bg-teal-500/10 rounded-lg text-teal-400">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
            </div>
            <h2 className="text-xl font-bold text-white">Better Sorting</h2>
          </div>
          <p className="text-slate-400 leading-relaxed">
            Date sorting now handles "Today" and "Yesterday" correctly so your results always appear in the right order.
          </p>
        </section>
        ...
        <section className="animate-in fade-in slide-in-from-left-4 duration-500 delay-500">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-xl font-bold text-white">Cleaner UI</h2>
          </div>
          <p className="text-slate-400 leading-relaxed">
            A subtle progress bar now shows when data is loading in the background. Page layout shifts and table jumping during navigation have been eliminated for a smoother experience.
          </p>
        </section>
      </div>

      <div className="mt-16 pt-8 border-t border-slate-800 text-center animate-in fade-in duration-1000 delay-700">
        <p className="text-sm text-slate-500 italic mb-6">
          Instant Pagination and Quick Actions are off by default — you can enable them in the Advanced settings.
        </p>
        <button 
          onClick={() => window.close()}
          className="bg-teal-600 hover:bg-teal-500 text-white font-bold py-3 px-8 rounded-lg shadow-lg shadow-teal-900/20 transition-all active:scale-95 cursor-pointer"
        >
          Got it, let's hunt!
        </button>
      </div>
